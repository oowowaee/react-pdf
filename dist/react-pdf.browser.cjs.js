...
var processRuns = function processRuns(string, runs, isReversed) {
...
var fontSubstitution = function fontSubstitution() {
  return function (_ref) {
    ...
    var _processRuns = processRuns(string, runs),
        results = _processRuns.results,
        lastFont = _processRuns.lastFont,
        lastIndex = _processRuns.lastIndex;
